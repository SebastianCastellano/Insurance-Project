function [liabilities, duration] = liabilities(C, T, qx, px, spot, lx)
% Compute the liabilities value for T years
%
% INPUTS
% C = matrix of capitals to be paid from time 1 to T 
% T = time to maturity
...
% duration = duration of the liabilities
